...
HD_PWD='/home/tinytangent/ucore-plus-fpga/Simple_Arithmetic/Simple_Arithmetic.runs/OpUnitSub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OpUnitSub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OpUnitSub.tcl
