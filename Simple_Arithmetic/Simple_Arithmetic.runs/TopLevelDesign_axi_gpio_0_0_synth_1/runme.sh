...
HD_PWD='/home/tinytangent/ucore-plus-fpga/Simple_Arithmetic/Simple_Arithmetic.runs/TopLevelDesign_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelDesign_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevelDesign_axi_gpio_0_0.tcl
