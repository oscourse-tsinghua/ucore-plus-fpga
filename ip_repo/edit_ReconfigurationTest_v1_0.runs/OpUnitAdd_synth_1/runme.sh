...
HD_PWD='/home/tinytangent/ucore-plus-fpga/ip_repo/edit_ReconfigurationTest_v1_0.runs/OpUnitAdd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OpUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OpUnit.tcl
