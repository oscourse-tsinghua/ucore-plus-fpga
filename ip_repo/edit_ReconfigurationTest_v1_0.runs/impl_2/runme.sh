...
HD_PWD='/home/tinytangent/ucore-plus-fpga/ip_repo/edit_ReconfigurationTest_v1_0.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ReconfigurationTest_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReconfigurationTest_v1_0.tcl -notrace
