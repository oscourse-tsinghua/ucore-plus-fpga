...
HD_PWD='/home/tinytangent/ucore-plus-fpga/ip_repo/edit_ReconfigurationTest_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReconfigurationTest_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReconfigurationTest_v1_0.tcl
