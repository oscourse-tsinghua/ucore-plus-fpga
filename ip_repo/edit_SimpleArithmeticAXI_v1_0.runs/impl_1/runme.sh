...
HD_PWD='/home/tinytangent/ucore-plus-fpga/ip_repo/edit_SimpleArithmeticAXI_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleArithmeticAXI_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SimpleArithmeticAXI_v1_0.tcl -notrace
