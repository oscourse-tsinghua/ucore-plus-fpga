...
HD_PWD='/home/tinytangent/ucore-plus-fpga/ip_repo/edit_SimpleArithmeticAXI_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleArithmeticAXI_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SimpleArithmeticAXI_v1_0.tcl
